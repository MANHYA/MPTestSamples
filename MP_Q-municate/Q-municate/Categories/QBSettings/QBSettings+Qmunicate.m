...
//            QBSettings.accountKey = @"6Qyiz3pZfNsex1Enqnp7";
            ...
            QBSettings.applicationID = 66806;
            QBSettings.authKey = @"Pyzny-63UURu8gG";
            QBSettings.authSecret = @"bcQMZ-w7GU5ZduP";
            QBSettings.accountKey = @"ok2dVYCiJqC5zM-agwDi";
    ...
    QBSettings.applicationGroupIdentifier = @"group.com.pandey.qmunicate";
