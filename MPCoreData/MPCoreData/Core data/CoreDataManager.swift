...
class CoreDataManager {
    ...
    /*Insert*/
    func insertPerson(name: String, mobile : String)->Person? {
        ...
        person.setValue(mobile, forKeyPath: "mobile")
    ...
    func update(name:String, mobile : String, person : Person) {
        ...
        do {
            ...
            person.setValue(mobile, forKey: "mobile")
            
            print("\(person.value(forKey: "name"))")
            print("\(person.value(forKey: "mobile"))")
    ...
    func delete(mobile: String) -> [Person]? {
