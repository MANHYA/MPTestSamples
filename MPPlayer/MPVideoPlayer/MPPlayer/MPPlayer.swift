...
public protocol MPPlayerDelegate : class {
...
public class MPPlayer: UIView {
    
    public weak var delegate:MPPlayerDelegate?
   
    fileprivate var player:AVPlayer?
    fileprivate var playerLayer:AVPlayerLayer?
    fileprivate var playerItem:AVPlayerItem?
    fileprivate var playUrl:String!
    fileprivate var playButton:MPPlayButton!
    fileprivate var playActivityIndicator:MPPlayerActivityIndicicatorView!
    fileprivate var smallPlayButton:MPPlayButton!
    fileprivate var rotateSizeButton:MPPlayerRotateButton!
    fileprivate var playProgressView:MPPlayProgressView!
    fileprivate var playerSlider:MPPlayerSlider!
    ...
    fileprivate func initWithRotateButton() {
        ...
        rotateSizeButton = MPPlayerRotateButton()
    ...
    fileprivate func initWithPlayActivityIndicator() {
        ...
        playActivityIndicator = MPPlayerActivityIndicicatorView()
    ...
    fileprivate func initWithPlayProgressView() {
        ...
        playProgressView = MPPlayProgressView(progressViewStyle: .bar)
